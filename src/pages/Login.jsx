...
export default function Login() {
  ...
  return (
    <AuthLayout>
      <div className="w-full z-10 max-w-sm bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.07] rounded-2xl p-8 shadow-lg dark:shadow-none dark:backdrop-blur-sm">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-lg bg-gray-50 dark:bg-white/[0.04] border border-gray-200 dark:border-white/[0.08] text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/[0.07] hover:border-gray-300 dark:hover:border-white/20 transition-all duration-200 mb-4"
        >
        ...
        <div className="flex justify-end mt-1">
          <Link
            to="/forgot-password"
            className="text-xs text-gray-500 dark:text-gray-600 hover:text-violet-600 dark:hover:text-violet-400 transition-colors"
          >
            Forgot password?
          </Link>
        </div>
