  ...
  return (
    <AuthLayout>
      <div className="w-full max-w-sm bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.07] rounded-2xl p-8 shadow-lg dark:shadow-none dark:backdrop-blur-sm">
        ...
        {error && (
          <p className="text-rose-600 dark:text-rose-400 text-xs mt-3">{error}</p>
        )}
        ...
        <p className="text-center text-xs text-gray-500 dark:text-gray-600 mt-6">
          ...
          <Link to="/login" className="text-violet-600 dark:text-violet-400 hover:text-violet-500 dark:hover:text-violet-300 transition-colors">
            Sign in
          </Link>
        </p>
